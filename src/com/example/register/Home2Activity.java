	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                SharedPreferences pref = Home2Activity.this.getSharedPreferences("data2",MODE_PRIVATE);
                SharedPreferences.Editor editor = pref.edit();
                editor.putString("Content",message);
                editor.commit();
                Toast.makeText(Home2Activity.this, "写入成功" , Toast.LENGTH_LONG).show();
                m_input.setText("");
			}
		});
		...
		m_output.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                Toast.makeText(Home2Activity.this, "读取成功" , Toast.LENGTH_LONG).show();
			}
		});
	}
