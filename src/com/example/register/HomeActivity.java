	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                SharedPreferences pref = HomeActivity.this.getSharedPreferences("data",MODE_PRIVATE);
                SharedPreferences.Editor editor = pref.edit();
                editor.putString("Content",message);
                editor.commit();
                Toast.makeText(HomeActivity.this, "写入成功" , Toast.LENGTH_LONG).show();
                m_input.setText("");
			}
		});
		...
		m_output.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                Toast.makeText(HomeActivity.this, "读取成功" , Toast.LENGTH_LONG).show();
			}
		});
	}
