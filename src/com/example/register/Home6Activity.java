...
public class Home6Activity extends Activity implements View.OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		m_ok.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
                ...
                SharedPreferences pref = Home6Activity.this.getSharedPreferences("data6",MODE_PRIVATE);
                SharedPreferences.Editor editor = pref.edit();
                editor.putString("Content",message);
                editor.commit();
                Toast.makeText(Home6Activity.this, "写入成功" , Toast.LENGTH_LONG).show();
                m_input.setText("");
			}
		});
		...
		m_output.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				SharedPreferences pre = getSharedPreferences("data6",MODE_PRIVATE);
                String mess = pre.getString("Content","");
                m_input.setText(mess);
                Toast.makeText(Home6Activity.this, "读取成功" , Toast.LENGTH_LONG).show();
			}
		});
	}
